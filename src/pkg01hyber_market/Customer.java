...
public class Customer extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Con = DriverManager.getConnection("jdbc:derby://localhost:1527/user1", "user1", "1234");
            String Query = "Update User1.CUSTOMERS set NAME='"+ name.getText()+"'" + "WHERE ID="+id.getText();
            String Query1 = "Update User1.CUSTOMERS set PASSWORD='"+ pass.getText()+"'" + "WHERE ID="+id.getText();
            String Query2 = "Update User1.CUSTOMERS set PHONE_NUMBER='"+ phone.getText()+"'" + "WHERE ID="+id.getText();
            Statement Add = Con.createStatement();
            Add.executeUpdate(Query);
            Add.executeUpdate(Query1);
            Add.executeUpdate(Query2);
            JOptionPane.showMessageDialog(this, "INFO had Updated");
            SelectSeller();
